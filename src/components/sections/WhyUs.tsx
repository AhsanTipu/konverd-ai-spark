    ...
    <section id="why" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {items.map((i) => (
            <div key={i.title} className="p-7 rounded-2xl bg-card border border-border hover:border-primary/30 hover:-translate-y-1 transition-all duration-300">
              <div className="h-11 w-11 rounded-xl bg-ink text-primary-foreground flex items-center justify-center">
